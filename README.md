...
| 계층 | 역할 | 주기 |
|------|------|------|
| **AlertWatchService** | 포그라운드 감시. 등말소 08–23시 또는 라인업 창만 | 라인업 **15초** · 등말소 **25초** |
...
| 필드 | 설명 | 현재 |
|------|------|------|
| `versionName` | 사용자에게 보이는 버전 | `1.3.86` |
| `versionCode` | 업데이트 비교용 정수 (배포마다 +1) | `1094` |
