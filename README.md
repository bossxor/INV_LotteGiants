...
현재 버전: **`1.3.34`** (`versionCode` **1041**). `app/build.gradle.kts`에서만 올립니다.
...
- **KBO 순위** · 타이틀 순위 · 등록/말소 공시 (엔트리·타이틀은 보고 있는 팀 기준). 롯데 행 위에 **잔여 경기·5위/1위 매직넘버**
...
| 필드 | 설명 | 현재 |
|------|------|------|
| `versionName` | 사용자에게 보이는 버전 | `1.3.34` |
| `versionCode` | 업데이트 비교용 정수 (배포마다 +1) | `1041` |
